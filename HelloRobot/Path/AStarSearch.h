...
public: // methods
	...
	unsigned int SearchStep()
	{
		...
		else // not goal
		{
			...
			vector<MapSearchNode*> ret = n->m_UserState.GetSuccessors( n->parent ? &n->parent->m_UserState : NULL );
...
private: // methods
	...
	{
		node ->m_UserState = MapSearchNode(-1,-1);
		m_AllocateNodeCount --;
